    ...
    <div class="row my-3">
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <form method="POST" action="/wayang" class="form-floating">
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('credit') is-invalid @enderror" id="credit" name="credit" placeholder="URL" required value="{{ old('credit') }}">
                            @error('credit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
